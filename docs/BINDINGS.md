...
| `<leader><Right>` | n | `swap_right` | transpose.char | Swap char with right neighbor (count = repeat N times) |
| `<leader><Left>` | n | `swap_left` | transpose.char | Swap char with left neighbor (count = repeat N times) |
| `<leader><Right>` | x | `swap_right_visual` | transpose.char | Swap selection with right neighbor char (count = repeat N times) |
| `<leader><Left>` | x | `swap_left_visual` | transpose.char | Swap selection with left neighbor char (count = repeat N times) |
